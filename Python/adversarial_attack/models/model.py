...
class ScattDense(nn.Module):
    def __init__(self, input_shape=(28, 28), J=2, L=8):
        ...
        self.in_features = self.K * self.scatt_output_shape[0] * self.scatt_output_shape[1]
        self.fc1 = nn.Linear(in_features=self.in_features, out_features=self.in_features // 2)
        self.fc2 = nn.Linear(in_features=self.in_features // 2, out_features=10)
...
if __name__ == '__main__':
    ...
    summary(model, input_size=(1, 28, 28))
    print("")
    print("Scatt + Dense model:")
    model = ScattDense().to("cuda")
    summary(model, input_size=(1, 28, 28))
