...
from models.resnet34 import ResNet34, ScattResNet34
...
def main():
    ...
    batch_size = 64
    epochs = 350
    max_images = 5000  # nbr of images available in STL10
    nb_samples_train = 200  # nbr of images to pick from the training set
    ...
    for model_class in [ResNet34, ScattResNet34]:
        ...
        for epoch in range(1, epochs + 1):
            ...
            print("/!\\ Model {} best accuracy {}%".format(model.__class__.__name__, best_accuracy))
