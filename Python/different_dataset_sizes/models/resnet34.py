# coding:utf-8
"""
  Purpose:  ResNet34 and ScattResNet34 for STL10 benchmarks
"""
...
class ScattResNet34(nn.Module):
    def __init__(self, block=BasicBlock, num_classes=10, input_shape=(96, 96), J=2, L=8):
