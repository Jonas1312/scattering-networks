...
class ScattResNet(nn.Module):

    def __init__(self, order=1, input_shape=(32, 32), J=2, L=8, block=BasicBlock, layers=[2, 2, 2, 2], num_classes=10):
        ...
        self.order = order
        self.scattering = Scattering2D(J=J, L=L, shape=input_shape, max_order=order)
