...
# some compatible validate data with the specified batch size. The number of
# channels in the validate data here is set to `3`, corresponding to the three
# colors channels in an RGB image.

scattering = Scattering2D(J, shape=(M, N), L=L, max_order=max_order)
